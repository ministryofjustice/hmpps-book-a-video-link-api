...
echo
read -r -p "You are about to disable the BVLS HMCTS link and guest pin features in the activities and appointments '$ENV' environment. Are you sure you want to proceed? (y/n) " yn
...
type: Opaque
stringData:
  BVLS_FEATURE_HMCTS_LINK_GUEST_PIN: "false"
EOF
