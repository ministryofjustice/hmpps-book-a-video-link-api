...
echo
read -r -p "You are about to disable the BVLS notes feature in the BVLS '$ENV' environment. Do you want to proceed? (y/n) " yn
...
type: Opaque
stringData:
  FEATURE_MASTER_PUBLIC_PRIVATE_NOTES: "false"
EOF
...
echo
echo "Restarting BVLS deployments on namespace $NAMESPACE"
