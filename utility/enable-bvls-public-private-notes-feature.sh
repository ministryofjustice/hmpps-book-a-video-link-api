...
echo
read -r -p "You are about to enable the BVLS notes feature in the BVLS '$ENV' environment. Do you want to proceed? (y/n) " yn
...
type: Opaque
stringData:
  FEATURE_MASTER_PUBLIC_PRIVATE_NOTES: "true"
EOF
