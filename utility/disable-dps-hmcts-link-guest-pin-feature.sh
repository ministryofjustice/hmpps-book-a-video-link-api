...
echo
read -r -p "You are about to disable the BVLS HMCTS link and guest pin features in the Digital Prisons '$ENV' environment. Are you sure you want to proceed? (y/n) " yn
...
type: Opaque
stringData:
  BVLS_HMCTS_LINK_GUEST_PIN_FEATURE_TOGGLE_ENABLED: "false"
EOF
