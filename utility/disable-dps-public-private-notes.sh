...
echo
read -r -p "You are about to disable the BVLS notes features in the Digital Prisons '$ENV' environment. Are you sure you want to proceed? (y/n) " yn
...
type: Opaque
stringData:
  BVLS_PUBLIC_PRIVATE_NOTES_FEATURE_TOGGLE_ENABLED: "false"
EOF
