...
echo
read -r -p "You are about to disable the BVLS notes feature in the activities and appointments '$ENV' environment. Do you want to proceed? (y/n) " yn
...
type: Opaque
stringData:
  BVLS_FEATURE_MASTER_PUBLIC_PRIVATE_NOTES: "false"
EOF
