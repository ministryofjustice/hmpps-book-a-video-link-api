...
echo
read -r -p "You are about to enable the BVLS pick up times feature on the daily schedule in the '$ENV' environment. Do you want to proceed? (y/n) " yn
