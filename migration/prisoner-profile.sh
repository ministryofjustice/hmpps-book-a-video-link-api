...
NAMESPACE="hmpps-prisoner-profile-$ENV"
SECRETS_FILE="hmpps-prisoner-profile-secrets.yaml"
...
echo "Restarting deployment hmpps-prisoner-profile on namespace $NAMESPACE"
kubectl -n "$NAMESPACE" rollout restart deployments/hmpps-prisoner-profile
