...
values (-1000, 1, 'ABCDEF', 'VLB_COURT_MAIN', 'comments about the hearing', 'PVI-ABCDEFG', '2100-07-24', '12:00', '13:00');
...
values (-1000, 'PVI', 'ABCDEF', '2100-07-24', 'VLB_COURT_MAIN', 'PVI-ABCDEFG', '12:00', '13:00');

insert into booking_history(booking_history_id, video_booking_id, history_type, court_id, hearing_type, comments, created_by, created_time)
values (-1100, -1000, 'AMEND', 1, 'APPEAL','comments about the hearing', 'test_user', '2024-07-24T02:00:00');

insert into booking_history_appointment (booking_history_id, prison_code, prisoner_number, appointment_date, appointment_type, prison_loc_key, start_time, end_time)
values (-1100, 'PVI', 'ABCDEF', '2100-07-25', 'VLB_COURT_MAIN', 'PVI-ABCDEFG', '12:00', '13:00');
...
values (-2000, 'COURT', 'ACTIVE', 400, 'TRIBUNAL', 'comments about the hearing', 'test_user', '2024-07-24T01:00:00', 'Free text court name');

insert into prison_appointment (video_booking_id, prison_id, prisoner_number, appointment_type, comments, prison_loc_key, appointment_date,  start_time, end_time)
values (-2000, 1, 'ABCDEF', 'VLB_COURT_MAIN', 'comments about the hearing', 'PVI-ABCDEFG', '2100-07-24', '12:00', '13:00');

insert into booking_history(booking_history_id, video_booking_id, history_type, court_id, hearing_type, comments, created_by, created_time)
values (-2000, -2000, 'CREATE',400, 'APPEAL','comments about the hearing', 'test_user', '2024-07-24T01:00:00');

insert into booking_history_appointment (booking_history_id, prison_code, prisoner_number, appointment_date, appointment_type, prison_loc_key, start_time, end_time)
values (-2000, 'PVI', 'ABCDEF', '2100-07-24', 'VLB_COURT_MAIN', 'PVI-ABCDEFG', '12:00', '13:00');
