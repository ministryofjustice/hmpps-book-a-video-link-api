...
insert into location_attribute (location_attribute_id, location_key, prison_id, location_status, location_usage, prison_video_url, notes, created_by, created_time)
values (801, 'VIDEOLINK', 27, 'ACTIVE', 'SCHEDULE', '/video-link/xxx', 'some notes', 'test_user', current_timestamp);
...
values (901, 801, 1, 4, '00:01', '23:59', 'COURT', 'test_user', current_timestamp),
       ...
       (903, 801, 6, 7, '00:01', '23:59', 'SHARED', 'test_user', current_timestamp);
