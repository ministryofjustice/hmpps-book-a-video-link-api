...
insert into prison_appointment (video_booking_id, prison_id, prisoner_number, appointment_type, notes_for_staff, prison_location_id, appointment_date,  start_time, end_time)
values (-4000, 1, 'ABCDEF', 'VLB_PROBATION', 'comments about the meeting', '926d8f38-7149-4fda-b51f-85abcbcb0d00'::uuid, '2099-01-24', '16:00', '17:00');
...
values (-4000, -4000, 'CREATE', 1, 'PSR','comments about the meeting', 'delius_user', '2024-01-01T01:00:00', 'delius@email.com');

insert into booking_history_appointment (booking_history_id, prison_code, prisoner_number, appointment_date, appointment_type, prison_location_id, start_time, end_time)
values (-4000, 'PVI', 'ABCDEF', '2099-01-24', 'VLB_PROBATION', '926d8f38-7149-4fda-b51f-85abcbcb0d00'::uuid, '17:00', '18:00');
