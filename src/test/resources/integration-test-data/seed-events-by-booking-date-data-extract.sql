...
values (-2000, 'WNI', 'ABCDEF', 'VLB_COURT_MAIN', 'comments about the hearing', 'WNI-ABCDEFG', '2099-01-24', '12:00', '13:00');
...
values (-2000, 'WNI', 'ABCDEF', '2099-01-24', 'VLB_COURT_MAIN', 'WNI-ABCDEFG', '12:00', '13:00');
...
insert into prison_appointment (video_booking_id, prison_code, prisoner_number, appointment_type, comments, prison_loc_key, appointment_date,  start_time, end_time)
values (-3000, 'WNI', 'ABCDEF', 'VLB_PROBATION', 'comments about the meeting', 'WNI-ABCDEFG', '2099-01-24', '16:00', '17:00');
...
insert into booking_history_appointment (booking_history_id, prison_code, prisoner_number, appointment_date, appointment_type, prison_loc_key, start_time, end_time)
values (-3000, 'WNI', 'ABCDEF', '2099-01-24', 'VLB_PROBATION', 'WNI-ABCDEFG', '16:00', '17:00');
