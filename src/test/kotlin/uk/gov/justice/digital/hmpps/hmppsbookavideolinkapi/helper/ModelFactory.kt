...
val courtUser = user(userType = UserType.EXTERNAL, name = "court user")
val prisonUser = user(userType = UserType.PRISON, name = "prison user")
val probationUser = user(userType = UserType.EXTERNAL, name = "probation user")
