...
@ContextConfiguration(classes = [VideoLinkBookingController::class, VideoLinkBookingControllerTest.TestConfig::class])
...
class VideoLinkBookingControllerTest {
  ...
  class TestConfig {
    @Bean
    fun videoBookingRepository() = mock<VideoBookingRepository>()

    @Bean
    fun referenceCodeRepository() = mock<ReferenceCodeRepository>()
