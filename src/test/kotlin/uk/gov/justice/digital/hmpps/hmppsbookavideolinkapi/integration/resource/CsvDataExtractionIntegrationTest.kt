...
class CsvDataExtractionIntegrationTest : IntegrationTestBase() {
  ...
  fun `should download court hearing events by hearing date`() {
    ...
    response.toString() contains "eventId,timestamp,videoLinkBookingId,eventType,agencyId,court,courtId,madeByTheCourt,mainStartTime,mainEndTime,preStartTime,preEndTime,postStartTime,postEndTime,mainLocationName,preLocationName,postLocationName\n" +
