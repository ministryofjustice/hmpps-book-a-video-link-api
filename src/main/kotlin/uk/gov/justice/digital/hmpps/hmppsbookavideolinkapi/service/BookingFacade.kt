  ...
  private fun sendCourtBookingEmails(eventType: BookingAction, booking: VideoBooking, prisoner: Prisoner, user: User?) {
    ...
    contacts.mapNotNull { contact ->
      when (contact.contactType) {
        ...
        ContactType.COURT -> if (booking.createdByPrison || eventType == BookingAction.RELEASED || eventType == BookingAction.TRANSFERRED) CourtEmailFactory.court(contact, prisoner, booking, prison, main, pre, post, locations, eventType) else null
