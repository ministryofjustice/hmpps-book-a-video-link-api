  ...
  protected fun VideoBooking.commonProperties(): Map<String, String> =
    if (isCourtBooking()) {
      ...
      mapOf(
        ...
        "prison_code" to prisonCode(),
        "location_key" to meeting().prisonLocationId,
