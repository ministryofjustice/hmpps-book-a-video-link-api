...
class ProbationBookingCreatedTelemetryEvent(
  ...
  override fun properties() = booking
    .commonProperties()
    .plus("created_by" to if (booking.createdByPrison) "prison" else "probation")
    .plus("delius_user" to if (user is DeliusUser) "true" else "false")
