...
values ( 1, 'COURT_HEARING_TYPE', 'APPEAL', 'Appeal', 'TIM', current_timestamp),
       ...
       (37, 'APPOINTMENT_TYPE', 'VLB_COURT', 'Video link booking - court', 'TIM', current_timestamp),
       (38, 'APPOINTMENT_TYPE', 'VLB_PROBATION', 'Video link booking - probation', 'TIM', current_timestamp),
       (39, 'EXTERNAL_SYSTEM', 'AA', 'Activities and appointments', 'TIM', current_timestamp),
       (40, 'EXTERNAL_SYSTEM', 'NOMIS', 'NOMIS', 'TIM', current_timestamp),
       (41, 'NOTIFY_REASON', 'NOTIFY_3RD_PARTY', 'Notify third party', 'TIM', current_timestamp),
       (42, 'NOTIFY_REASON', 'NOTIFY_COURT', 'Notify court contact', 'TIM', current_timestamp),
       (43, 'NOTIFY_REASON', 'NOTIFY_PROBATION', 'Notify probation contact', 'TIM', current_timestamp),
       (44, 'NOTIFY_REASON', 'NOTIFY_PRISON', 'Notify prison contact', 'TIM', current_timestamp),
       (45, 'NOTIFY_REASON', 'NOTIFY_OWNER', 'Notify owner', 'TIM', current_timestamp),
       (46, 'HISTORY_TYPE', 'HIST_CREATED', 'Created', 'TIM', current_timestamp),
       (47, 'HISTORY_TYPE', 'HIST_AMENDED', 'Amended', 'TIM', current_timestamp),
       (48, 'HISTORY_TYPE', 'HIST_CANCELLED', 'Cancelled', 'TIM', current_timestamp);
