...
values
  ...
  ('PROBATION_MEETING_TYPE', 'FTR56', '56-day fixed term recall (FTR56)', 'MATT', current_timestamp, true, 2),
  ('PROBATION_MEETING_TYPE', 'RR', 'Recall report (PRARR - parts B or C)', 'MATT', current_timestamp, true, 3),
